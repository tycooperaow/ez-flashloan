...
await web3.eth.getTransactionCount(addressFrom).then(txCount => {
  ...
  console.log("transaction data is constructed")
  // fire away!
...
// Sends transaction with the given transaction data.
